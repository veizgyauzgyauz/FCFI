...
class SBDEvaluationDataset(ISDataset):
    def __init__(self, dataset_path, split='val', target_name_list=None, target_instance_id_list=None, **kwargs):
    ...
    def get_sample(self, index) -> DSample:
        ...
        return DSample(image_name + '#%3d'%instance_id, image, instances_mask, objects_ids=[1], sample_id=index)
